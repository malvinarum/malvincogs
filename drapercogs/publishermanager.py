...
from draperbundle.utilities import get_member_activity, get_supported_platforms
...
class PublisherManager(commands.Cog):
    ...
    async def parse_playing(self, ctx, existing_data):
        ...
        async def services_parser(
            ...
            platform_prompt[str(len(platform_prompt))] = "none"
            platform_prompt[str(len(platform_prompt))] = "delete"
